...
import com.user.project.domain.exception.BusinessException;
import com.user.project.domain.exception.EntityNotFoundException;
import com.user.project.domain.model.User;
import com.user.project.domain.usecase.RetrieveUserInformationUseCase;
import com.user.project.domain.usecase.UserDeletionUseCase;
import com.user.project.domain.usecase.UserUpsertUseCase;
...
public class UserControllerTest {
    ...
    void shouldThrowValidationExceptionWhenUpdatingUser(UserRequest request) throws Exception {
        Long userId = 1L;
    ...
    static Stream<UserRequest> provideInvalidUpdateUserRequests() {
        return Stream.of(
